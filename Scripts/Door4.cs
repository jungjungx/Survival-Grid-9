...
public class Door4 : MonoBehaviour
{
    ...
    void Update()
    {
        ponbutton = GameObject.Find("Player").GetComponent<PlayerMove_v2>().door_available4;
...
{
    Vector3 uppos= new Vector3(57.2f, 39f, 0f);
    Vector3 downpos= new Vector3(57.2f, 31.9f, 0f);
    float counter = 0;
