...
public class Door1 : MonoBehaviour
{
    ...
    void Update()
    {
        ponbutton = GameObject.Find("Player").GetComponent<PlayerMove_v2>().door_available1;
...
{
    Vector3 uppos= new Vector3(35.2f, 61f, 0f);
    Vector3 downpos= new Vector3(35.2f, 53.9f, 0f);
    float counter = 0;
