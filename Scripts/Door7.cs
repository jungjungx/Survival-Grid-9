...
public class Door7 : MonoBehaviour
{
    ...
    void Update()
    {
        ponbutton = GameObject.Find("Player").GetComponent<PlayerMove_v2>().door_available7;
...
{
    Vector3 uppos= new Vector3(35.2f, 17f, 0f);
    Vector3 downpos= new Vector3(35.2f, 9.9f, 0f);
    float counter = 0;
